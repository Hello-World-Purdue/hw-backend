...
const getCurrentUsersApplication = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const getUserApplication = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //update query
    const result = yield User_1.User.findByIdAndUpdate(id, { name: userObject.name }, { new: true });
...
const apply = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const appQuery = application_1.Application.findOneAndUpdate({ user }, Object.assign(Object.assign({}, applicationBody), { user }), {
        new: true,
        upsert: true,
